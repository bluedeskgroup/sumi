...
class _EditProductPageState extends State<EditProductPage> {
  ...
  void _initializeFields() {
    ...
    // Check if brand exists in the list, otherwise set to null
  ...
  Future<void> _saveChanges() async {
    ...
    try {
      ...
      final updatedProduct = ProductModel(
        ...
        tags: _selectedBrand != null ? [_selectedBrand!] : widget.product.tags,
        createdAt: widget.product.createdAt,
        updatedAt: DateTime.now(),
        salesRate: widget.product.salesRate,
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildCurrentProductImage(),
                    const SizedBox(height: 12),
                    _buildProductDetailsButton(),
                    const SizedBox(height: 24),
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                  widget.product.type == ProductType.product 
                      ? 'تعديل بيانات المنتجات والخدمات'
  ...
  Widget _buildCurrentProductImage() {
    return Row(
      children: [
        // Product details
        Expanded(
  ...
  Widget _buildProductDetailsButton() {
    return Container(
      width: 144,
      height: 48,
      decoration: BoxDecoration(
    ...
    return Column(
      ...
      children: [
        ...
        _buildInputField(
          ...
          placeholder: 'يتم كتابة اسم المنتج أو الخدمة',
        ),
  ...
  Widget _buildImageUploadCard(int index) {
    ...
    final bool isLastCard = index == 3 && widget.product.images.isNotEmpty;
  ...
  Widget _buildAdditionalDataSection() {
    return Column(
      children: [
        ...
        // Brand selection
        _buildDropdownField(
          label: 'اختيار ماركة المنتج',
          value: _selectedBrand,
          placeholder: 'حدد العلامة التجارية',
          items: _brands,
